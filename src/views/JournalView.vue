...
.page-title h2 {
  font-family: 'Poppins', 'Noto Sans TC', sans-serif;
  font-size: clamp(1.4rem, 4vw, 2rem); color: #2c1e08;
  text-shadow: 0 1px 0 rgba(255,255,255,.9), 0 2px 10px rgba(255,255,255,.5);
  margin-bottom: .3rem;
}
.page-title p {
  font-family: 'Poppins', 'Noto Sans TC', sans-serif;
  font-style: italic; font-size: .9rem; color: #7a5c30;
}
.edit-btn {
  padding: .4rem .9rem;
  background: linear-gradient(145deg, #faf5e8, #f0e8cc);
  border: 1.5px solid #d4b870; border-radius: 2px;
  box-shadow: 2px 2px 0 #8a6e10;
  font-family: 'Poppins', 'Noto Sans TC', sans-serif; font-size: .7rem;
  letter-spacing: .08em; color: #6a5030;
  cursor: pointer; white-space: nowrap; flex-shrink: 0;
  transition: transform .2s, box-shadow .2s;
}
.edit-btn:hover { transform: translate(-1px,-1px); box-shadow: 3px 3px 0 #8a6e10; }
.edit-btn.is-owner {
  border-color: #c9a227;
  background: linear-gradient(145deg, #fdf5c8, #f0e060);
  color: #4a3000;
}
...
.modal-box {
  ...
  box-shadow: 5px 5px 0 #8a6e10, inset 0 1px 0 rgba(255,255,255,.85);
  padding: 1.8rem 1.6rem 1.4rem;
}
.modal-title {
  font-family: 'Poppins', 'Noto Sans TC', sans-serif; font-size: .85rem;
  letter-spacing: .12em; color: #3d2810;
...
.phrase-input {
  ...
  padding: .55rem .75rem;
  font-family: 'Poppins', 'Noto Sans TC', sans-serif;
  font-size: 1rem; color: #2c1e08;
  outline: none; letter-spacing: .08em;
  transition: border-color .2s, box-shadow .2s;
}
.phrase-input::placeholder { color: #b0906a; opacity: .75; }
.phrase-input:focus { border-color: #c9a227; box-shadow: 0 0 0 2px rgba(201,162,39,.18); }
.eye-btn {
...
.eye-btn:hover { border-color: #c9a227; }
.phrase-error {
...
.btn-cancel {
  ...
  border: 1.5px solid #c8b888; border-radius: 2px;
  font-family: 'Poppins', 'Noto Sans TC', sans-serif; font-size: .72rem;
  letter-spacing: .08em; color: #7a6030; cursor: pointer;
  transition: border-color .2s, color .2s;
}
.btn-cancel:hover { border-color: #8a6e10; color: #3d2810; }
.enter-btn {
  padding: .45rem 1.2rem;
  background: linear-gradient(145deg, #f5e88a, #e8d060);
  border: 1.5px solid #c9a227; border-radius: 2px;
  box-shadow: 2px 2px 0 #8a6e10;
  font-family: 'Poppins', 'Noto Sans TC', sans-serif; font-size: .72rem;
  letter-spacing: .1em; color: #3d2810; cursor: pointer;
  transition: transform .2s, box-shadow .2s;
}
...
.spin-rune {
  display: inline-block; color: #c9a227; font-size: 1.5rem;
...
.new-btn {
  ...
  letter-spacing: .12em; color: #5a3e10; cursor: pointer;
  transition: transform .2s, box-shadow .2s;
}
.new-btn:hover { transform: translate(-1px,-1px); box-shadow: 4px 4px 0 #8a6e10; }
.star { color: #c9a227; font-size: .65rem; }
...
.form-label { font-family: 'Poppins', 'Noto Sans TC', sans-serif; font-size: .68rem; letter-spacing: .15em; color: #6a5030; }
...
.form-input:focus, .form-textarea:focus { border-color: #c9a227; box-shadow: 0 0 0 2px rgba(201,162,39,.18); }
...
.btn-save {
  ...
  box-shadow: 2px 2px 0 #8a6e10;
  font-family: 'Poppins', 'Noto Sans TC', sans-serif; font-size: .72rem;
  letter-spacing: .08em; color: #3d2810; cursor: pointer;
  transition: transform .2s, box-shadow .2s;
}
.btn-save:hover:not(:disabled) { transform: translate(-1px,-1px); box-shadow: 3px 3px 0 #8a6e10; }
...
.empty-state p { font-family: 'Poppins', 'Noto Sans TC', sans-serif; font-style: italic; color: #7a5c30; }
...
.entry-card.is-expanded { border-color: #c9a227; }
.entry-header {
  display: flex; align-items: center; justify-content: space-between;
  padding: .9rem 1.2rem; cursor: pointer;
  user-select: none; transition: background .15s;
}
.entry-header:hover { background: rgba(201,162,39,.06); }
.entry-meta { display: flex; align-items: center; gap: .5rem; flex-wrap: wrap; min-width: 0; }
.entry-date { font-family: 'Poppins', 'Noto Sans TC', sans-serif; font-size: .7rem; letter-spacing: .08em; color: #8a6e10; white-space: nowrap; }
.entry-dot { color: #c8b888; }
.entry-title { font-family: 'Poppins', 'Noto Sans TC', sans-serif; font-size: 1.05rem; font-weight: 400; color: #2c1e08; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.expand-arrow { font-size: .72rem; color: #b89840; flex-shrink: 0; }
.entry-body { padding: 0 1.2rem 1.1rem; }
.entry-rule { height: 1px; background: linear-gradient(90deg, transparent, #d4b870, transparent); margin-bottom: 1rem; }
.entry-content { font-family: 'Poppins', 'Noto Sans TC', sans-serif; font-size: 1rem; line-height: 1.85; color: #3a2a10; white-space: pre-wrap; word-break: break-word; margin: 0 0 1rem; }
.entry-footer { display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: .4rem; }
.entry-ts { font-family: 'Poppins', 'Noto Sans TC', sans-serif; font-size: .62rem; letter-spacing: .08em; color: #a08848; opacity: .75; }
.btn-delete {
  padding: .25rem .8rem; background: transparent;
  border: 1px solid #c8a8a8; border-radius: 2px;
